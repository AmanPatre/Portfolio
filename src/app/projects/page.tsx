  ...
  return (
    <div style={{ paddingTop: "100px", paddingBottom: "4rem", position: "relative", zIndex: 10 }}>
      <div className="container-main">
        ...
        {/* Stats bar */}
        <div style={{ display: "flex", gap: "2rem", marginBottom: "2.5rem", padding: "0.85rem 1.25rem", background: "rgba(0,210,255,0.03)", border: "1px solid rgba(0,210,255,0.1)", borderRadius: "6px", flexWrap: "wrap" }}>
          {[
